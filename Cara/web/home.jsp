...
<html lang="en">
    ...
    <head>
        ...
        /* Additional styling for sections if necessary */
        #hero, #features, #product1, #banner, #sm-banner, #l-banner {
            background-color: black; /* Ensuring sections also have black background */
        }
    </style>
    ...
    <style>
    body {
        background-color: black; /* Màu n?n là ?en */
        color: white; /* Màu ch? m?c ??nh là tr?ng */
    }

    h1, h2, h3, h4, h5, h6, p {
        color: black; /* ??m b?o t?t c? các tiêu ?? và ?o?n v?n ??u có màu tr?ng */
    }

    /* Các ph?n khác c?a mã CSS */
    #hero, #features, #product1, #banner, #sm-banner, #l-banner {
        background-color: white; /* ??m b?o các ph?n c?ng có màu n?n ?en */
    }
</style>
